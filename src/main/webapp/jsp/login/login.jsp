...
<div class="productTable" >
    ...
    <div class="layui-form-item">
        <div class="layui-input-block" style="text-align: center;">
            <button  class="layui-btn" onclick="regist()">注册
            </button>
        </div>
    </div>
    <form class="layui-form" style="width: 400px;margin: 0px auto">
        ...
        <div class="layui-form-item" style="margin-right: 60px;margin-top: 40px;">
            <div class="layui-input-block" style="text-align: center;">
                <button style="width: 100px;margin-right: 20px;" class="layui-btn" lay-submit lay-filter="submitForm">登录
                </button>
            </div>
        </div>
    </form>
...
<script>
            ...
            form.on("submit(submitForm)",function (data) {
                ...
                $.ajax({
                    ...
                    success:function (data) {
                        ...
                        if(data.code==200){
                            window.top.layer.msg('登录成功！');
                            window.localStorage.setItem("token",data.SESSIONID);
                            window.location.href=ctx+"/jsp/shop/user_list.jsp?token="+data.SESSIONID
                        }else{
    ...
    function regist() {
        window.location.href=ctx+"/jsp/login/regist.jsp"
    }
